  ...
  return (
    <section className="bg-[#07091D] py-20 px-4">
        <div className="max-w-7xl mx-auto">
            <div className="flex gap-10 p-12 bg-white/10 border border-[#00FFFF]/30 shadow-[0_0_15px_#00FFFF]/50 rounded-xl">
                <div className="flex mb-6 flex-col w-[50%] gap-6">
                    <button className="px-6 py-3 bg-mars-orange text-white font-bold rounded-lg uppercase mb-6 hover:bg-orange-600 transition-colors duration-300 w-[50%]">
                    Cérémonie de clôture
                    </button>
                    <h2 className="text-white text-4xl md:text-[100px] font-bold">MARS.A.I <br />NIGHT</h2>
