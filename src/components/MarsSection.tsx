  ...
  const events: EventCardProps[] = [
    {
      id: 1,
      title: "DÉFI 1 MINUTE",
      description: "Repoussez les limites de la narration. Un format ultra-court pour créer une œuvre IA percutante en 60 secondes chrono.",
    ...
    },
    {
      ...
      description: "Des ateliers pratiques et gratuits. Apprenez à maîtriser le Prompt Engineering et les outils de génération vidéo.",
    ...
    },
    {
      ...
      description: "Un point de rencontre unique entre réalisateurs, experts tech et passionnés pour réinventer ensemble le 7ème art.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
            ...
            <p className="text-gray-400 mt-4 max-w-2xl text-lg">
              L'événement hybride où l'intelligence artificielle rencontre la créativité cinématographique.
            </p>
        </div>
