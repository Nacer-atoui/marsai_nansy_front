...
import type { Director, Submit } from '../types';
  ...
  return (
    <div className="p-10 border-[#364153] rounded-xl border font-display">
      ...
      <div className={rowClass}>
        ...
        <div className={colClass}>
          <label className={labelClasses}>
            {t('submit_director.firstname', 'Prénom*')}
          </label>
          <input
            type="text"
            name="firstname"
      ...
      <div className={rowClass}>
        <div className={colClass}>
          <label className={labelClasses}>
            {t('submit_director.lastname', 'Nom*')}
          </label>
          <input
            type="text"
            name="lastname"
      ...
      <div className={rowClass}>
        <div className={colClass}>
          ...
          <input
            ...
            className={inputStyle}
            placeholder={t(
              'submit_director.street_placeholder',
              '123 rue de Marseille'
            )}
          />
        </div>
        <div className={colClass}>
          <label className={labelClasses}>
            {t('submit_director.zipcode', 'Code Postal*')}
          </label>
          <input
            type="text"
      ...
      <div className={rowClass}>
        ...
        <div className={colClass}>
          <label className={labelClasses}>
            {t('submit_director.country', 'Pays*')}
          </label>
          <input
            type="text"
            name="country"
